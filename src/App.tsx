...
import { Download, FileCode2, Shield, Brain, Zap, GitPullRequest, Search, Bot, Cpu, AlertTriangle, CheckCircle, Database } from 'lucide-react';
...
const iconMap: Record<string, React.ReactNode> = {
  ...
  'claude-secrets-guard.yml': <Shield className="w-5 h-5 text-red-400" />,
  ...
  'codex-review.yml': <Cpu className="w-5 h-5 text-blue-500" />,
  'grok-analyst.yml': <Bot className="w-5 h-5 text-indigo-400" />,
};
...
export default function App() {
  ...
  const [fileType, setFileType] = useState<'workflow' | 'memory'>('workflow');
